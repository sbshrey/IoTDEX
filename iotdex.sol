...
contract iotdex {
    ...
    function producer_register (string name, uint[] sensors, uint[] costs) public returns (address) {
    ...
    function get_producer (address addr) public view returns (string name) {
    ...
    function publish_metadata (address producer_address, uint sensor_type, string schema, uint timestamp, string ipfs,uint key_index, uint _encID ) public returns (address) {
    ...
    function sensor_metadata (address producer_address, uint sensor_type, uint index) public view returns (string schema, uint timestamp, uint price) {
    ...
    function transfer_key(string dec_key,address _to, uint sensor_type, uint index) public returns (string) {
